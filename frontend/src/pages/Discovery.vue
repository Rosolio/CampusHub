<template>
  <div class="min-h-screen bg-surface font-body text-on-surface">
    ...
    <main class="mx-auto max-w-7xl px-6 pb-24 pt-24">
        ...
        <div class="grid gap-6 xl:grid-cols-[1.1fr_0.9fr] xl:items-start">
          <div>
            <div class="mb-4 flex flex-wrap items-center gap-3">
              <span class="rounded-full bg-teal-900 px-4 py-2 text-xs font-bold uppercase tracking-[0.22em] text-white">校园需求广场</span>
              <span class="rounded-full border border-teal-200 bg-white/80 px-4 py-2 text-xs font-bold text-teal-900">任务优先展示</span>
            </div>
            ...
            <p class="mt-4 max-w-2xl text-base leading-7 text-slate-600">
              首页优先展示跑腿代办和学习辅导。二手、交友、求助、兼职等公开互动内容进入独立话题广场，适合围绕评论持续交流。
            </p>
          ...
          <div class="grid gap-4 md:grid-cols-2">
            <article class="rounded-[1.6rem] bg-teal-950 p-5 text-white shadow-[0_18px_40px_rgba(15,23,42,0.14)]">
              <p class="text-xs font-bold uppercase tracking-[0.18em] text-cyan-100/70">任务接单</p>
              <h2 class="mt-2 text-2xl font-extrabold">明确履约</h2>
            ...
            >
              ...
              <p class="mt-4 text-sm leading-7 text-slate-600">
                二手、交友、求助、兼职等更适合公开讨论的内容，统一进入独立话题页。
              </p>
      ...
      <div class="mb-6 grid gap-4 lg:grid-cols-[minmax(0,1fr)_18rem]">
        <section ref="taskSection" class="rounded-[1.75rem] bg-surface-container-lowest p-4 shadow-sm sm:p-5">
